export default {
  rankActivieyTitle: 'Super Lucky Star',
  ...
  rules3: 'Highest ranked users can win different levels of rewards. The rank is based on  the  total coins you receive from  {box_name} and Super Gift Box during the Competition phase. ',
